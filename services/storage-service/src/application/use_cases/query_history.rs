...
use storage_domain::{QueryRequest, QuoteRepository, TimeRange};
    ...
    R: QuoteRepository<Item = Value> + Send + Sync,
{
    ...
    pub async fn execute(
        ...
        // 创建时间范围
        let time_range =
            TimeRange::new(start, end).map_err(|e| anyhow::anyhow!("时间范围无效: {}", e))?;
        ...
        self.repository
            .find_by_code(&request.code, start_ts, end_ts)
            .await
