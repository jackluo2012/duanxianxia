...
pub struct StartBacktestRequest {
    ...
    pub strategy_params: crate::domain::entities::models::StrategyParams,
    pub backtest_period: crate::domain::entities::models::BacktestPeriod,
...
mod tests {
    use super::*;
    use crate::domain::entities::models::{BacktestPeriod, StrategyParams};
